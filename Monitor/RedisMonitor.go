...
func parseRedisResult(res []client.Result) AppRedisJson {
	...
	//	if res[0].Series[0].Values[i][indexOfUuid] != nil {
	//		container_uuid = res[0].Series[0].Values[i][indexOfUuid].(string)
	//	}
	...
	//	i = 0
	//	for res[0].Series[0].Values[i][indexOfId] == nil {
	//		i++
	//	}
	...
	//	i = 0
	//	for res[0].Series[0].Values[i][indexOfName] == nil {
	//		i++
	//	}
	...
	//	i = 0
	//	for res[0].Series[0].Values[i][indexOfNamespace] == nil {
	//		i++
	//	}
	...
	//	i = 0
	//	for res[0].Series[0].Values[i][indexOfType] == nil {
	//		i++
	//	}
